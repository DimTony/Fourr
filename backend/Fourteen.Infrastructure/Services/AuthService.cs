...
namespace Fourteen.Infrastructure.Services
{
    public class AuthServices : IAuthServices
    {
        ...
        {
            // Store PKCE challenge + callback override against state
            _memoryCache.Set($"oauth:{state}", new OAuthState(codeChallenge, callbackOverride), 
                    TimeSpan.FromMinutes(10));

            var redirect = callbackOverride ?? "https://yourapp.com/auth/github/callback";
        ...
        private async Task<TokenPair> IssueTokenPairAsync(User user, CancellationToken ct)
        {
            ...
            // Generate a raw refresh token (random, not a JWT)
            ...
            return new TokenPair(
                ...
                RefreshToken: rawRefresh,   // return raw — caller stores/sends this
